...
| `docs/obsidian/Arquitetura de Dados.md` | Postgres↔Memory, provider selector, capabilities |
...
| `docs/obsidian/Rotas da API.md` | Estrutura, padrão, healthz, SSE |
...
| `docs/obsidian/Estrutura do Backend.md` | árvore de pastas complete |
...
> [!tip] Navegação
> [[MOC — Histórico do Projeto]] · [[MEMORY|Obsidian MEMORY]] · [[CURRENT_STATE]]
