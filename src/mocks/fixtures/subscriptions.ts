...
export const mockSubscriptions: Subscription[] = [
  { company_id: 'comp-1', plan_id: 'pro', billing_status: 'active', trial_ends_at: null, current_period_ends_at: new Date(Date.now() + 25 * 86400000).toISOString(), blocked_reason: null },
  { company_id: 'comp-2', plan_id: 'premium', billing_status: 'active', trial_ends_at: null, current_period_ends_at: new Date(Date.now() + 20 * 86400000).toISOString(), blocked_reason: null },
  { company_id: 'comp-3', plan_id: 'basic', billing_status: 'trial', trial_ends_at: new Date(Date.now() + 10 * 86400000).toISOString(), current_period_ends_at: new Date(Date.now() + 10 * 86400000).toISOString(), blocked_reason: null },
]
