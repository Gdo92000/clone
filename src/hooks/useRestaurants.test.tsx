...
describe('useRestaurants', () => {
  ...
  it('useRestaurant with valid id fetches that restaurant', async () => {
    ...
    vi.mocked(getRestaurantById).mockResolvedValue(mockRestaurant as unknown as Restaurant);
  ...
  it('useMenuItems fetches menu items for restaurant', async () => {
    ...
    vi.mocked(getMenuItems).mockResolvedValue(mockItems as unknown as MenuItem[]);
